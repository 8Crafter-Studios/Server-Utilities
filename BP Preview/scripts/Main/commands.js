import { Block, BlockPermutation, DimensionTypes, ItemStack, system, world, EquipmentSlot, ContainerSlot, BlockTypes, ItemTypes, CompoundBlockVolume, BlockVolume } from "@minecraft/server";
import { targetSelectorB, targetSelectorAllListB, targetSelectorAllListC, targetSelectorAllListE, targetSelector, getTopSolidBlock, arrayModifier, targetSelectorAllListD, format_version, JSONParse, JSONStringify, getParametersFromString, extractJSONStrings, fillBlocksB, srun, fillBlocksC, fillBlocksCG, fillBlocksH, fillBlocksHW, fillBlocksHB, fillBlocksHH, fillBlocksHO, fillBlocksHP, scanForContainerBlocks, clearAllContainerBlocks, fillBlocksHC, fillBlocksHT, fillBlocksHSG, fillBlocksHHSG, fillBlocksHDG, fillBlocksHSSG, fillBlocksHOG, fillBlocksHHOG, fillBlocksHSGG, fillBlocksHISGG } from "../Main";
import { coordinatesB, evaluateCoordinates, anglesToDirectionVectorDeg, roundVector3ToMiddleOfBlock, generateTickingAreaFillCoordinatesC, } from "./coordinates";
import { savedPlayer } from "./player_save.js";
import { settings, mainMenu, managePlayers, terminal, manageCommands } from "./ui.js";
