const exports = (() => {
  ...
  `.replace(/\s+/g, ""),
    ...
    function F(e2, t, n, i2) {
        ...
        if (a === "(") {
            ...
            if ((e2.pushModX(e2.getCurrentModX()), e2.numOpenGroups++, (n === "(" && !e2.captureGroup) || n === "(?:"))
                return { token: s2(o2.GroupOpen, n, { kind: g.group }) };
            if (n === "(?>") return { token: s2(o2.GroupOpen, n, { kind: g.atomic }) };
            if (n === "(?=" || n === "(?!" || n === "(?<=" || n === "(?<!")
                return { token: s2(o2.GroupOpen, n, { kind: n[2] === "<" ? g.lookbehind : g.lookahead, negate: n.endsWith("!") }) };
  ...
  `,
    ...
    function w(e2) {
        ...
        return e2 === "-"
            ? s2(o2.CharacterClassHyphen, e2)
            : e2 === "&&"
            ? s2(o2.CharacterClassIntersector, e2)
            : (v(e2), s2(o2.Character, e2, { value: e2.codePointAt(0) }));
    }
    function O(e2, { inCharClass: t }) {
        ...
        if (/^\\x[89A-Fa-f]\p{AHex}/u.test(e2))
            try {
                const i2 = e2
                        .split(/\\x/)
                        .slice(1)
                        .map((u) => parseInt(u, 16)),
                    a = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }).decode(new Uint8Array(i2)),
                    p = new TextEncoder();
                return [...a].map((u) => {
    ...
    function W(e2, t) {
        ...
        i2 ??= "";
        const a = (t.getCurrentModX() || n.includes("x")) && !i2.includes("x"),
            p = b(n),
            r4 = b(i2),
            u = {};
    ...
    function X(e2) {
        const t = {};
        if (e2[0] === "{") {
            const { min: n, max: i2 } = /^\{(?<min>\d*)(?:,(?<max>\d*))?/.exec(e2).groups,
                a = 1e5;
            ...
            (t.min = e2[0] === "+" ? 1 : 0), (t.max = e2[0] === "?" ? 1 : 1 / 0), (t.kind = e2[1] === "+" ? C.possessive : e2[1] === "?" ? C.lazy : C.greedy);
    ...
    function D(e2) {
        const { p: t, neg: n, value: i2 } = /^\\(?<p>[pP])\{(?<neg>\^?)(?<value>[^}]+)/.exec(e2).groups,
            a = (t === "P" && !n) || (t === "p" && !!n);
    ...
    function b(e2) {
        const t = {};
        return (
            e2.includes("i") && (t.ignoreCase = true),
            e2.includes("m") && (t.dotAll = true),
            e2.includes("x") && (t.extended = true),
    ...
    function z(e2) {
        ...
        for (const n of e2)
            t[{ i: "ignoreCase", m: "dotAll", x: "extended", D: "digitIsAscii", P: "posixIsAscii", S: "spaceIsAscii", W: "wordIsAscii" }[n]] = true;
        return t;
    }
    function N(e2) {
    ...
    function ne(e2, r4 = {}) {
        const n = {
                ...
                ...r4,
                rules: { captureGroup: false, singleline: false, ...r4.rules },
            },
            a = P(e2, { flags: n.flags, rules: { captureGroup: n.rules.captureGroup, singleline: n.rules.singleline } }),
            t = {
                capturingGroups: [],
                current: 0,
    ...
    function te(e2) {
        const { raw: r4 } = e2.token,
            n = /^\\k[<']/.test(r4),
            a = n ? r4.slice(3, -1) : r4.slice(1),
            t = (o3, i2 = false) => {
                const c2 = e2.capturingGroups.length;
                let u = false;
                if (o3 > c2)
                    if (e2.skipBackrefValidation) u = true;
    ...
    function ae(e2, r4) {
        const { parent: n, tokens: a, walk: t } = e2,
            o3 = n.elements.at(-1),
            i2 = a[e2.current];
        if (
            !r4.isCheckingRangeEnd &&
            o3 &&
            o3.type !== s3.CharacterClass &&
            o3.type !== s3.CharacterClassRange &&
            i2 &&
            i2.type !== o2.CharacterClassOpen &&
            i2.type !== o2.CharacterClassClose &&
            i2.type !== o2.CharacterClassIntersector
        ) {
    ...
    function oe(e2, r4) {
        const { token: n, tokens: a, walk: t } = e2,
            o3 = a[e2.current],
            i2 = [G()];
        let c2 = J(o3);
        ...
        return (
            i2.length === 1
                ? (u.elements = i2[0].elements)
                : ((u.kind = L.intersection), (u.elements = i2.map((h2) => (h2.elements.length === 1 ? h2.elements[0] : h2)))),
            e2.current++,
            u
        );
    }
    ...
    function ie(e2, r4) {
        ...
        let u = pe(n);
        const h2 = u.type === s3.AbsentFunction,
            y2 = u.kind === b2.lookbehind,
            N2 = y2 && u.negate;
        if ((u.type === s3.CapturingGroup && (t.push(u), u.name && s(o3, u.name, []).push(u)), h2 && r4.isInAbsentFunction))
        ...
        for (; p.type !== o2.GroupClose; ) {
            if (p.type === o2.Alternator) u.alternatives.push(k2()), e2.current++;
                ...
                const m = u.alternatives.at(-1),
                    d = c2(m, {
                        ...r4,
                        isInAbsentFunction: r4.isInAbsentFunction || h2,
                        isInLookbehind: r4.isInLookbehind || y2,
                        isInNegLookbehind: r4.isInNegLookbehind || N2,
                    });
    ...
    function ue({ token: e2, parent: r4 }) {
        const { min: n, max: a, kind: t } = e2,
            o3 = r4.elements.at(-1);
        if (!o3 || o3.type === s3.Assertion || o3.type === s3.Directive || o3.type === s3.LookaroundAssertion)
    ...
    function ce(e2) {
        ...
        if (o3) {
            const c2 = +o3.groups.num,
                u = n.length;
            if (((e2.hasNumberedRef = true), (t = { "": c2, "+": u + c2, "-": u + 1 - c2 }[o3.groups.sign]), t < 1))
            ...
            c(
                {
                    ...
                    "\\B": f.word_boundary,
                    "\\G": f.search_start,
                    "\\y": f.grapheme_boundary,
                    "\\Y": f.grapheme_boundary,
                    "\\z": f.string_end,
                    "\\Z": f.string_end_newline,
                }[e2],
                `Unexpected assertion kind "${e2}"`
            ),
            { negate: e2 === o`\B` || e2 === o`\Y` }
        );
    }
    function P2(e2, r4) {
        const n = !!r4?.orphan;
    ...
    function T(e2, r4) {
        const n = !!r4?.negate,
            a = { type: s3.CharacterSet, kind: c(A2[e2], `Unexpected character set kind "${e2}"`) };
        return (
            (e2 === h.digit || e2 === h.hex || e2 === h.newline || e2 === h.space || e2 === h.word) && (a.negate = n),
            (e2 === h.grapheme || (e2 === h.newline && !n)) && (a.variableLength = true),
            a
        );
    }
    function K(e2, r4) {
    ...
    function fe(e2) {
        return e2
            ...
            .replace(/[A-Za-z]+/g, (r4) => r4[0].toUpperCase() + r4.slice(1).toLowerCase());
    }
    function $2(e2) {
    ...
    var emoji_regex_xs_default = () =>
        new RegExp(r`[\u{1F1E6}-\u{1F1FF}]{2}|\u{1F3F4}[${sTags}]{2}[\u{E0030}-\u{E0039}${sTags}]{1,3}\u{E007F}|${seq}(?:\u200D${seq})*`, "gu");
    ...
    function T2(A3, C2, p = null) {
        ...
        function l(e2, i2 = null, r4 = null, a = null) {
            ...
            const u = {
                ...
                h2 = C2["*"],
                m = C2[e2.type],
                k3 = typeof h2 == "function" ? h2 : h2?.enter,
                M3 = typeof m == "function" ? m : m?.enter;
            if ((k3?.(u, p), M3?.(u, p), !n))
                switch (e2.type) {
                    case s3.Regex:
     ...
     * @type {RegExp}
     */
    var atomicPluginToken;
    try {
        atomicPluginToken = new RegExp(String.raw`(?<noncapturingStart>${noncapturingDelim})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`, "gsu");
    } catch (e) {
        if (
            e instanceof SyntaxError &&
            String.raw`(?<noncapturingStart>${noncapturingDelim})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`.includes("\\-") &&
            e?.message === "invalid escape sequence in regular expression"
        ) {
            atomicPluginToken = new RegExp(String.raw`(?<noncapturingStart>${noncapturingDelim})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`, "gs");
        } else {
            if (e instanceof Error) {
                e.message = `Invalid regexp at: /${String.raw`(?<noncapturingStart>${noncapturingDelim})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`}/gsu. ${e.message}`;
                throw e;
            } else {
                throw new Error(`Invalid regexp at: /${String.raw`(?<noncapturingStart>${noncapturingDelim})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`}/gsu. Thrown value: ${JSON.stringify(e)}`);
            }
        }
    }
                ...
                if (m === "[") {
                    ...
                    if (m === aGDelim && !inAG) {
                        ...
                        if (!numGroupsOpenInAG) {
                            ...
                            expression = `${expression.slice(0, aGPos)}${emulatedAGDelim}${expression.slice(
                                aGPos + aGDelim.length,
                                index
     ...
     * @type {RegExp}
     */
    var possessivePluginToken;
    try {
        possessivePluginToken = new RegExp(
            String.raw`
  \\(?: \d+
    | c[A-Za-z]
    | [gk]<[^>]+>
  ...
  `.replace(/\s+/g, ""),
            ...
            if (e instanceof Error) {
                e.message = `Invalid regexp at: /${String.raw`
  \\(?: \d+
    | c[A-Za-z]
    | [gk]<[^>]+>
    | [pPu]\{[^\}]+\}
  ...
  | (?<qBase>${baseQuantifier})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
  | \\?.
  `.replace(/\s+/g, "")}/gsu. ${e.message}`;
                throw e;
            } else {
                throw new Error(`Invalid regexp at: /${String.raw`
  \\(?: \d+
    | c[A-Za-z]
    | [gk]<[^>]+>
    | [pPu]\{[^\}]+\}
  ...
  | (?<qBase>${baseQuantifier})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
  | \\?.
  `.replace(/\s+/g, "")}/gsu. Thrown value: ${JSON.stringify(e)}`);
            }
        }
    }
                ...
                if (qMod === "+" && lastToken && !lastToken.startsWith("(")) {
                    ...
                    if (/^\{\d+\}$/.test(qBase)) {
                        ...
                        if (lastToken === ")" || lastToken === "]") {
                            ...
                            expression = `${expression.slice(0, nodeIndex)}(?>${expression.slice(nodeIndex, index)}${qBase})${expression.slice(
                                index + m.length
                            )}`;
                        } else {
            ...
            if (m === "[") {
                ...
                if (rDepth) {
                    ...
                    if (!isWithinReffedGroup) {
                        throw new Error(
                            r2`Recursive \g cannot be used outside the referenced group "${
                                mode === "external" ? gRNameOrNum : r2`\g<${gRNameOrNum}&R=${gRDepth}>`
                            }"`
                        );
                    }
    ...
    function makeRecursive(left, right, reps, isSubpattern, hiddenCaptures, addedHiddenCaptures, numCapturesPassed) {
        ...
        const rest = [reps, isSubpattern ? namesInRecursed : null, hiddenCaptures, addedHiddenCaptures, numCapturesPassed];
  ...
  XID_Start XIDS`
    ...
    var FirstPassVisitor = {
        AbsentFunction({ node, parent, replaceWith }) {
            ...
            if (kind === F2.repeater) {
                const group = prepContainer(S(), [adoptAndSwapKids(Q({ negate: true }), alternatives), Y("Any")]);
            ...
            enter({ node, parent, replaceWith, skip }, { groupOriginByCopy, groupsByName, multiplexCapturesToLeftByRef, openRefs, reffedNodesByReferencer }) {
                ...
                for (let i2 = 0; i2 < multiplexNodes.length; i2++) {
                    ...
                    if (
                        ...
                        (origin && origin === multiplex.origin) || // This group is not from subroutine expansion, and it comes after a subroutine expansion
    ...
    var ThirdPassVisitor = {
        Backreference({ node, parent, replaceWith }, state) {
            ...
            if (!participants.length) {
                ...
                const alts = participants.map((reffed) => adoptAndSwapKids(k2(), [P2(reffed.number)]));
    ...
    function isAlwaysNonZeroLength(node) {
        const types = [s3.Character, s3.CharacterClass, s3.CharacterSet];
    ...
    function isLoneGLookaround(node, options) {
        ...
        return (
            node.type === s3.LookaroundAssertion &&
            (opts.negate === null || node.negate === opts.negate) &&
            hasOnlyChild(node, (kid) => kid.kind === f.search_start)
        );
    }
    ...
    function genCharacterClass(node, state, gen) {
        ...
        if (!state.inCharClass) {
            if (!state.useFlagV && !negate) {
                const negatedChildClasses = elements.filter((kid) => kid.type === s3.CharacterClass && kid.kind === L.union && kid.negate);
        ...
        if (
            ...
            kind === L.union &&
            !negate &&
            firstEl && // Allows many nested classes to work with `target` ES2018 which doesn't support nesting
            (((!state.useFlagV || !state.verbose) && parent.kind === L.union && !(envFlags.literalHyphenIncorrectlyCreatesRange && state.useFlagV)) ||
                (!state.verbose &&
                    parent.kind === L.intersection && // JS doesn't allow intersection with union or ranges
                    elements.length === 1 &&
                    firstEl.type !== s3.CharacterClassRange))
        ) {
    ...
    function genGroup({ atomic: atomic2, flags, parent, alternatives }, state, gen) {
        ...
        const result =
            !state.verbose && alternatives.length === 1 && parent.type !== s3.Quantifier && !atomic2 && (!state.useFlagMods || !flags)
                ? contents
    ...
    function getCharEscape(codePoint, { escDigit, inCharClass, useFlagV }) {
        ...
        if (
            ...
            codePoint < 32 ||
            (codePoint > 126 && codePoint < 160) || // Unicode planes 4-16; unassigned, special purpose, and private use area
...
export const JavaScriptScanner = exports.JavaScriptScanner;
export const createJavaScriptRawEngine = exports.createJavaScriptRawEngine;
export const createJavaScriptRegexEngine = exports.createJavaScriptRegexEngine;
export const defaultJavaScriptRegexConstructor = exports.defaultJavaScriptRegexConstructor;
