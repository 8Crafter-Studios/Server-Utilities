...
const folders: string[] = ["blocks", "dialogue", "entities", "functions", "item_catalog", "items", "loot_tables", "recipes", "scripts", "structures"];
const files: string[] = ["contents.json"];
const sourceFolder: string = path.join(process.argv[1]!, "../../BP/");
