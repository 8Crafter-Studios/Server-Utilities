    ...
    run(commandstring, executor, player, event) { if (this.type == "custom") {
        if (this?.code != undefined) {
            ...
            if (this.customCommandType == "commands") {
                ...
                eval("`" + this.code.map(v => String.raw `${v}`).join("\n") + "`");
            }
        }
        else {
            ...
            case !!switchTest.match(/^extinguish$/):
                {
                    ...
                    try {
                        system.run(() => { let a = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "fire" }); let b = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "soul_fire" }); player.sendMessage(`${a == 0 ? "§c" : ""}${a + b} blocks extinguished in radius of ${radius}`); });
                    }
                    catch (e) {
                        eventData.sender.sendMessage("§c" + e + e.stack);
                    }
            ...
            case !!switchTest.match(/^remexp$/):
                {
                    ...
                    switch (player.dimension.id) {
                        case "minecraft:overworld":
                            try {
                                system.run(() => { let a = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "tnt" }); let b = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "respawn_anchor" }); player.sendMessage(`${a == 0 ? "§c" : ""}${a + b} explosives removed in radius of ${radius}`); });
                            }
                            catch (e) {
                                eventData.sender.sendMessage("§c" + e + e.stack);
                            }
                        ...
                        case "minecraft:nether":
                            try {
                                system.run(() => { let a = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "tnt" }); let b = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "bed" }); player.sendMessage(`${a == 0 ? "§c" : ""}${a + b} explosives removed in radius of ${radius}`); });
                            }
                            catch (e) {
                                eventData.sender.sendMessage("§c" + e + e.stack);
                            }
                        ...
                        case "minecraft:the_end":
                            try {
                                system.run(() => { let a = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "tnt" }); let b = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "respawn_anchor" }); let c = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "bed" }); player.sendMessage(`${a == 0 ? "§c" : ""}${a + b + c} explosives removed in radius of ${radius}`); });
                            }
                            catch (e) {
                                eventData.sender.sendMessage("§c" + e + e.stack);
                            }
                        ...
                        default:
                            try {
                                system.run(() => { let a = fillBlocksH(from, to, player.dimension, "air", { matchingBlock: "tnt" }); player.sendMessage(`${a == 0 ? "§c" : ""}${a} explosives removed in radius of ${radius}`); });
                            }
                            catch (e) {
                                eventData.sender.sendMessage("§c" + e + e.stack);
                            }
