...
export class executeCommandPlayer {
    constructor(player) { this.player = player; this.location = player.location; this.dimension = player.dimension; this.rotation = player.getRotation(); }
    ...
    addEffect(effectType, duration, options) { return this.rotation ?? this.player.addEffect(effectType, duration, options); }
    addExperience(amount) { return this.rotation ?? this.player.addExperience(amount); }
            ...
            case !!switchTest.match(/^swapitems$/):
                {
                    ...
                    if ((switchTestB.split(/\s+/g)[4] ?? "").trim() == "") {
                        args[4] = player.name;
                    }
                    else {
                        if ((switchTestB.split(/\s+/g)[4] ?? "").trim() == "~") {
