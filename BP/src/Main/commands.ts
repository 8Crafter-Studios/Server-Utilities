...
export const commands = [
    ...
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "setitem", escregexp: {v: "^setitem$"}, formats: [{format: "invsee <target: targetSelector>"}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:setitem"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "item", escregexp: {v: "^item$"}, formats: [{format: ""}], command_version: "1.5.0", description: "", commandSettingsId: "built-inCommandSettings:item"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "invsee", escregexp: {v: "^invsee$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:invsee"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "offlineinfo", escregexp: {v: "^offlineinfo$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:offlineinfo"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "offlineuuidinfo", escregexp: {v: "^offlineuuidinfo$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:offlineuuidinfo"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "offlineinvsee", escregexp: {v: "^offlineinvsee$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:offlineinvsee"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "offlineuuidinvsee", escregexp: {v: "^offlineuuidinvsee$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:offlineuuidinvsee"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "binvsee", escregexp: {v: "^binvsee$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:binvsee"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "einvsee", escregexp: {v: "^einvsee$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:einvsee"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "invseeuuidmode", escregexp: {v: "^invseeuuidmode$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:invseeuuidmode"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "h#", escregexp: {v: "^h#$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:h#"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "hset", escregexp: {v: "^hset$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:hset"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gmc", escregexp: {v: "^gmc$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gmc"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gms", escregexp: {v: "^gms$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gms"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gma", escregexp: {v: "^gma$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gma"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gmd", escregexp: {v: "^gmd$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gmd"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gmp", escregexp: {v: "^gmp$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gmp"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "gmr", escregexp: {v: "^gmr$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:gmr"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "getuuid", escregexp: {v: "^getuuid$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:getuuid"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "warpset", escregexp: {v: "^warpset$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:warpset"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "warp", escregexp: {v: "^warp$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:warp"}, 
    ...
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "run", escregexp: {v: "^run$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:run"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "eval", escregexp: {v: "^eval$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:eval"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "top", escregexp: {v: "^top$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:top"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "up", escregexp: {v: "^up$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:up"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "printlayers", escregexp: {v: "^printlayers$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:printlayers"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "mainmenu", escregexp: {v: "^mainmenu$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:mainmenu"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "settings", escregexp: {v: "^settings$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:settings"}, 
    ...
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§6", commandName: "morph", escregexp: {v: "^morph$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:morph"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§6", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§6", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
    {type: "built-in", requiredTags: ["canUseChatCommands"], formatting_code: "§r§f", commandName: "", escregexp: {v: "^$"}, formats: [{format: ""}], command_version: "1.0.0", description: "", commandSettingsId: "built-inCommandSettings:"}, 
...
export class command{
    ...
    constructor(command: {type: "built-in"|"custom"|"unknown", formatting_code?: string, customCommandType?: "commands"|"javascript", customCommandId?: string, commandSettingsId?: string, command_version?: string|number, commandName: string, description?: string, escregexp?: {v: string, f?: string}, formats?: command_formats_type_list, format_version?: string|number, commands_format_version?: string|number}|command) {
        this.type = command.type??"unknown"; 
        let commandtest = (command.type=="built-in"?commands.find(v=>v.commandName==command.commandName):(command.type=="custom"?JSONParse(world.getDynamicPropertyIds().find(v=>v=="customCommand:"+command.commandName)):((commands.find(v=>v.commandName==command.commandName)??JSONParse(world.getDynamicPropertyIds().find(v=>v=="customCommand:"+command.commandName)))))); 
    ...
    get code(){if(this.type=="custom"){if(this?.customCommandId!=undefined){return world.getDynamicPropertyIds().filter(v=>v.startsWith("customCommandCode:")).sort((a, b)=>Number(a?.split(":")?.slice(-1)[0])-Number(b?.split(":")?.slice(-1)[0])).map(v=>String(world.getDynamicProperty(v)))}else{throw new TypeError("Cannot get the code of the command because the customCommandId is undefined. ")}}else{throw new TypeError("Cannot get the code of the command because it is not a custom command or the type of the command is unknown. ")}}/*
...
export function chatMessage(eventData: ChatSendBeforeEvent){
    ...
    } else {if(world.getDynamicProperty("andexdbSettings:disableCustomChatMessages") != true){chatSend({returnBeforeChatSend, player, eventData, event, newMessage})}}
}
export function chatCommands(params: {returnBeforeChatSend: boolean|undefined, player: Player|undefined, eventData: ChatSendBeforeEvent, event: ChatSendBeforeEvent|undefined, newMessage: string|undefined}){
    ...
    system.run(()=>{try{for(let i = 0; i < 9; i++){inventoryg6.container.swapItems(i, i+18, inventoryblockc6.container)}; }catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}})
        ...
        case !!switchTest.match(/^invsee$$/): 
            eventData.cancel = true;
            system.run(()=>{const inventoryd2 = world.getPlayers().find((playerFinders)=>(playerFinders == targetSelectorB(newMessage.slice(8), "", Number(eventData.sender.id)))).getComponent("inventory") as EntityInventoryComponent
    try{let slotsArray = []; for(let i = 0; i < inventoryd2.inventorySize; i++){if (inventoryd2.container.getItem(Number(i)) !== undefined) {slotsArray = slotsArray.concat(String("slot: " + i + "§r§f, item: " + inventoryd2.container.getItem(Number(i)).typeId + "§r§f, amount: " + inventoryd2.container.getItem(Number(i)).amount + "§r§f, nameTag: " + inventoryd2.container.getItem(Number(i)).nameTag + "§r§f, lore: " + JSON.stringify(inventoryd2.container.getItem(Number(i)).getLore()??[])??"[]" + ", enchantments: " + JSON.stringify(inventoryd2.container.getItem(Number(i))?.getComponent("enchantable")?.getEnchantments()??null)??"null"))}else{slotsArray = slotsArray.concat("slot: " + i + ", item: minecraft:air")}}; ; eventData.sender.sendMessage(String(world.getPlayers().find((playerFinders)=>(playerFinders == targetSelectorB(newMessage.slice(8), "", Number(eventData.sender.id)))).name + "'s Items: \n" + slotsArray.join("§r§f\n")))}catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}})
        break; 
    ...
    try{let players = savedPlayer.getSavedPlayers().filter((p)=>(p.name==switchTestB.split(" ").slice(1).join(" "))); if(players.length==0){player.sendMessage("§cError: no players with that name were found")}else{if(players.length>1){player.sendMessage("§cError: multiple saved players with that name were found, with the following uuids: "+[players[0]?.id, players[1]?.id, players[2]?.id, players[3]?.id])}else{let player = players[0]; eventData.sender.sendMessage(String(player.name + (world.getAllPlayers().find((p)=>(p.id==player.id))!=undefined?" (Online)":" (last seen: "+new Date(Number(player.lastOnline)+(Number(event.sender.getDynamicProperty("andexdbPersonalSettings:timeZone") ?? 0)*3600000)).toLocaleString(/*'en-US', {dateStyle: "full",timeStyle: 'full',timeZone: String(world.getDynamicProperty("andexdb:timeZone") ?? "UTC"),timeZoneName: "long"}*/)+")") + " Data: \n" + arrayModifier(JSON.stringify(player).split(""), (v)=>(v as string).charCodeAt(0)).join()))}}}catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}
        ...
        case !!switchTest.match(/^offlineinvsee$$/): 
            eventData.cancel = true;
    try{let slotsArray = []; let players = savedPlayer.getSavedPlayers().filter((p)=>(p.name==switchTestB.split(" ").slice(1).join(" "))); if(players.length==0){player.sendMessage("§cError: no players with that name were found")}else{if(players.length>1){player.sendMessage("§cError: multiple saved players with that name were found, with the following uuids: "+[players[0]?.id, players[1]?.id, players[2]?.id, players[3]?.id])}else{let player = players[0]; let items = player.items.inventory.concat(player.items.equipment); items.forEach((item)=>{if (item.count != 0) {slotsArray = slotsArray.concat(String("slot: " + item.slot + "§r§f, item: " + item.id + "§r§f, amount: " + item.count + "§r§f, nameTag: " + item.name + "§r§f, lore: " + JSON.stringify(item.lore??[])??"[]" + "§r§f, enchantments: " + JSON.stringify(item.enchants??"N/A")??"N/A"))}else{slotsArray = slotsArray.concat("slot: " + item.slot + ", item: minecraft:air")}}); ; eventData.sender.sendMessage(String("(format_version: " + player.format_version + ") " + player.name + (world.getAllPlayers().find((p)=>(p.id==player.id))!=undefined?" (Online)":" (last seen: "+new Date(Number(player.lastOnline)+(Number(event.sender.getDynamicProperty("andexdbPersonalSettings:timeZone") ?? 0)*3600000)).toLocaleString()+")") + " Items: \n" + slotsArray.join("§r§f\n")))}}}catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}
        break; 
...
.datapickblock`.replaceAll("\n.", ("\n"+(world.getDynamicProperty("andexdbSettings:chatCommandPrefix") ?? "\\")))); 
        ...
        case !!switchTest.match(/^mainmenu$/): 
            eventData.cancel = true;
            try{player.runCommandAsync("/scriptevent andexdb:editorMenusAndLists hisa"); }catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}
        break; 
        case !!switchTest.match(/^settings$/): 
            eventData.cancel = true;
            try{player.runCommandAsync("/scriptevent andexdb:settings hisa"); }catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}
        break; 
        ...
        break; 
        default: 
        if(world.getDynamicProperty("andexdbSettings:sendMessageOnInvalidChatCommand") != true){eventData.cancel = true; }else{/*if(world.getDynamicProperty("andexdbSettings:chatCommandPrefix") != true){*/
        chatSend(params)/*
        }*/
        }
        break; 
