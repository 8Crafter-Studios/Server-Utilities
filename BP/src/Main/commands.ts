...
.datapickblock`.replaceAll("\n.", ("\n"+(world.getDynamicProperty("andexdbSettings:chatCommandPrefix") ?? "\\")))); 
        ...
        case !!switchTest.match(/^fill$/): 
            ...
            try{system.run(()=>{player.dimension.fillBlocks(coordinatesa, coordiantesb, BlockPermutation.resolve(firstblockname, firstblockstates), {matchingBlock: matchingblock}); }); }catch(e){eventData.sender.sendMessage("§c" + e + e.stack)}
