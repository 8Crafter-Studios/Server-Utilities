...
if (args.includes("--help") || args.includes("-h")) {
    console.log(`Usage: node changeVersionNumber-fr-mcpv.js [options]
...
let manifestBPRaw = readFileSync("./bppreview/manifest.json", "utf-8");

/**
 * @type {import("./bppreview/manifest.json")}
 */
const manifest = JSON5.parse(manifestBPRaw);

const originalVersion = manifest.header.version.join(".");
...
let manifestRPRaw = readFileSync("./rppreview/manifest.json", "utf-8");
let rawInitializeMainGlobalVariablesFileJS = readFileSync("./bppreview/scripts/initializeMainGlobalVariables.js", "utf-8");
let rawInitializeMainGlobalVariablesFileDTS = readFileSync("./bppreview/scripts/initializeMainGlobalVariables.d.ts", "utf-8");
/**
 ...
 * @type {string}
 */
let settingsScreenJSON = readFileSync("./rppreview/ui/settings_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let howToPlayScreenJSON = readFileSync("./rppreview/ui/how_to_play_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let enUSTextsLang = readFileSync("./rppreview/texts/en_US.lang", "utf-8");

if (newVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bppreview/scripts/initializeMainGlobalVariables.js does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bppreview/scripts/initializeMainGlobalVariables.d.ts does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!settingsScreenJSON.includes("(Version: " + originalVersion + " for ")) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./rppreview/ui/settings_screen.json does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (
        ...
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./rppreview/texts/en_US.lang does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    manifestBPRaw = manifestBPRaw
        .replaceAll(originalVersion, newVersion)
        .replaceAll(
            new RegExp(`\\[\\s*${originalVersion.split(".").slice(0, 3).join(",\\s*")}\\s*\\]`, "g"),
            `[${newVersion.split(".").slice(0, 3).join(", ")}]`
        );
    manifestRPRaw = manifestRPRaw
        .replaceAll(originalVersion, newVersion)
        .replaceAll(
            new RegExp(`\\[\\s*${originalVersion.split(".").slice(0, 3).join(",\\s*")}\\s*\\]`, "g"),
            `[${newVersion.split(".").slice(0, 3).join(", ")}]`
...
if (newMCVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bppreview/scripts/initializeMainGlobalVariables.js does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
                rawInitializeMainGlobalVariablesFileJS.match(
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bppreview/scripts/initializeMainGlobalVariables.d.ts does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
...
writeFileSync("./bppreview/manifest.json", manifestBPRaw);
writeFileSync("./rppreview/manifest.json", manifestRPRaw);
writeFileSync("./bppreview/scripts/initializeMainGlobalVariables.js", rawInitializeMainGlobalVariablesFileJS);
writeFileSync("./bppreview/scripts/initializeMainGlobalVariables.d.ts", rawInitializeMainGlobalVariablesFileDTS);
writeFileSync("./rppreview/ui/settings_screen.json", settingsScreenJSON);
writeFileSync("./rppreview/ui/how_to_play_screen.json", howToPlayScreenJSON);
writeFileSync("./rppreview/texts/en_US.lang", enUSTextsLang);
