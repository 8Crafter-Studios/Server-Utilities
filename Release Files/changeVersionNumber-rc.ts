...
if (args.includes("--help") || args.includes("-h")) {
    console.log(`Usage: node changeVersionNumber-fr.ts [options]
...
let manifestBPRaw = readFileSync("./release_candidates/bp/manifest.json", "utf-8");

/**
 * @type {import("./release_candidates/bp/manifest.json")}
 */
...
let manifestRPRaw = readFileSync("./release_candidates/rp/manifest.json", "utf-8");
let rawInitializeMainGlobalVariablesFileJS = readFileSync("./release_candidates/bp/scripts/initializeMainGlobalVariables.js", "utf-8");
let rawInitializeMainGlobalVariablesFileDTS = readFileSync("./release_candidates/bp/scripts/initializeMainGlobalVariables.d.ts", "utf-8");
/**
 ...
 * @type {string}
 */
let settingsScreenJSON = readFileSync("./release_candidates/rp/ui/settings_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let howToPlayScreenJSON = readFileSync("./release_candidates/rp/ui/how_to_play_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let enUSTextsLang = readFileSync("./release_candidates/rp/texts/en_US.lang", "utf-8");

if (newVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/bp/scripts/initializeMainGlobalVariables.js does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/bp/scripts/initializeMainGlobalVariables.d.ts does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!settingsScreenJSON.includes("(Version: " + originalVersion + " for ")) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/rp/ui/settings_screen.json does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (
        ...
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/rp/texts/en_US.lang does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
...
if (newMCVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/bp/scripts/initializeMainGlobalVariables.js does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
                rawInitializeMainGlobalVariablesFileJS.match(
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./release_candidates/bp/scripts/initializeMainGlobalVariables.d.ts does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
...
writeFileSync("./release_candidates/bp/manifest.json", manifestBPRaw);
writeFileSync("./release_candidates/rp/manifest.json", manifestRPRaw);
writeFileSync("./release_candidates/bp/scripts/initializeMainGlobalVariables.js", rawInitializeMainGlobalVariablesFileJS);
writeFileSync("./release_candidates/bp/scripts/initializeMainGlobalVariables.d.ts", rawInitializeMainGlobalVariablesFileDTS);
writeFileSync("./release_candidates/rp/ui/settings_screen.json", settingsScreenJSON);
writeFileSync("./release_candidates/rp/ui/how_to_play_screen.json", howToPlayScreenJSON);
writeFileSync("./release_candidates/rp/texts/en_US.lang", enUSTextsLang);
