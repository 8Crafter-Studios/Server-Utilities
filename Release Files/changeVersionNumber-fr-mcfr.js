...
if (args.includes("--help") || args.includes("-h")) {
    console.log(`Usage: node changeVersionNumber-fr-mcfr.js [options]
...
let manifestBPRaw = readFileSync("./bp/manifest.json", "utf-8");

/**
 * @type {import("./bp/manifest.json")}
 */
...
let manifestRPRaw = readFileSync("./rp/manifest.json", "utf-8");
let rawInitializeMainGlobalVariablesFileJS = readFileSync("./bp/scripts/initializeMainGlobalVariables.js", "utf-8");
let rawInitializeMainGlobalVariablesFileDTS = readFileSync("./bp/scripts/initializeMainGlobalVariables.d.ts", "utf-8");
/**
 ...
 * @type {string}
 */
let settingsScreenJSON = readFileSync("./rp/ui/settings_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let howToPlayScreenJSON = readFileSync("./rp/ui/how_to_play_screen.json", "utf-8");
/**
 ...
 * @type {string}
 */
let enUSTextsLang = readFileSync("./rp/texts/en_US.lang", "utf-8");

if (newVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bp/scripts/initializeMainGlobalVariables.js does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_format_version = "' + originalVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bp/scripts/initializeMainGlobalVariables.d.ts does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (!settingsScreenJSON.includes("(Version: " + originalVersion + " for ")) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./rp/ui/settings_screen.json does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
    ...
    if (
        ...
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./rp/texts/en_US.lang does not contain the original version number: \u001B[38;2;0;255;128mv${originalVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128mv${
...
if (newMCVersion !== "") {
    if (!rawInitializeMainGlobalVariablesFileJS.includes('mainGlobalVariables.current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bp/scripts/initializeMainGlobalVariables.js does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
                rawInitializeMainGlobalVariablesFileJS.match(
    ...
    if (!rawInitializeMainGlobalVariablesFileDTS.includes('const current_supported_minecraft_version = "' + originalMCVersion + '";')) {
        console.warn(
            `\u001B[38;2;255;255;0mWARNING: ./bp/scripts/initializeMainGlobalVariables.d.ts does not contain the original supported Minecraft version number: \u001B[38;2;0;255;128mv${originalMCVersion}\u001B[38;2;255;255;0m. Detected Version: \u001B[38;2;0;255;128m${
...
writeFileSync("./bp/manifest.json", manifestBPRaw);
writeFileSync("./rp/manifest.json", manifestRPRaw);
writeFileSync("./bp/scripts/initializeMainGlobalVariables.js", rawInitializeMainGlobalVariablesFileJS);
writeFileSync("./bp/scripts/initializeMainGlobalVariables.d.ts", rawInitializeMainGlobalVariablesFileDTS);
writeFileSync("./rp/ui/settings_screen.json", settingsScreenJSON);
writeFileSync("./rp/ui/how_to_play_screen.json", howToPlayScreenJSON);
writeFileSync("./rp/texts/en_US.lang", enUSTextsLang);
