...
export function extractSelectors(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        if (!insideQuotes) {
            ...
            else if (str[i] !== ' ' && str[i] !== '' && str[i] !== undefined && startIndex !== -1 && stack.length === 0 && (i - startIndex) >= 2) {
                selectors.push(str.substring(startIndex, i).trim());
                startIndex = -1;
            }
        }
    }
